...
//*
//PC.SRCLIB  DD DSN=DSNA10.DBAG.SRCLIB.DATA(REFLEMP),DISP=SHR
//PC.DBRMLIB   DD DSN=DSNA10.DBAG.DBRMLIB.DATA(REFLEMP),DISP=SHR
//*
...
//*
//PC.SYSIN   DD DSN=FTEST.DB2.SOURCE(REFLEMP),DISP=SHR
//*
//LKED.SYSLMOD DD DSN=DSNA10.DBAG.RUNLIB.LOAD(REFLEMP),DISP=SHR
/*